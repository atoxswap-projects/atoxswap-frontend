...
export const CHAIN_INFO: ChainInfoMap = {
  [SupportedChainId.MAINNET]: {
    ...
    docs: 'https://docs.atoxswap.com/',
    explorer: 'https://etherscan.io/',
    infoLink: 'https://info.atoxswap.com/#/',
    label: 'Ethereum',
  ...
  [SupportedChainId.OPTIMISM]: {
    ...
    infoLink: 'https://info.atoxswap.com/#/optimism/',
    label: 'Optimism',
    logoUrl: optimismLogoUrl,
    statusPage: 'https://optimism.io/status',
    helpCenterUrl: 'https://help.atoxswap.com/en/collections/3137778-uniswap-on-optimistic-ethereum-oξ',
    addNetworkInfo: {
      nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SupportedChainId.ARBITRUM_ONE]: {
    ...
    infoLink: 'https://info.atoxswap.com/#/arbitrum',
    label: 'Arbitrum',
    logoUrl: arbitrumLogoUrl,
    defaultListUrl: ARBITRUM_LIST,
    helpCenterUrl: 'https://help.atoxswap.com/en/collections/3137787-uniswap-on-arbitrum',
    addNetworkInfo: {
      nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SupportedChainId.POLYGON]: {
    ...
    infoLink: 'https://info.atoxswap.com/#/polygon/',
    label: 'Polygon',
