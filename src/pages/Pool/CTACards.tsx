...
export default function CTACards() {
  ...
  return (
    <CTASection>
      <CTA1 href={'https://help.atoxswap.com/en/articles/providing-liquidity-on-atoxswap'}>
        <ResponsiveColumn>
          <HeaderText>
            <Trans>Learn about providing liquidity</Trans> ↗
          </HeaderText>
          <ThemedText.Body fontWeight={300} style={{ alignItems: 'center', display: 'flex', maxWidth: '80%' }}>
            <Trans>Check out our LP walkthrough and migration guides.</Trans>
          </ThemedText.Body>
        </ResponsiveColumn>
      </CTA1>
      <CTA2 href={infoLink + 'pools'}>
        <ResponsiveColumn>
          ...
          <ThemedText.Body fontWeight={300} style={{ alignSelf: 'flex-start' }}>
            <Trans>Explore popular pools on atoxSwap Analytics.</Trans>
          </ThemedText.Body>
        </ResponsiveColumn>
      </CTA2>
    </CTASection>
