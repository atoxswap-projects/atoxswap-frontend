          ...
          <CardSection>
            <AutoColumn gap="md">
              ...
              <ExternalLink
                ...
                target="_blank"
                href="https://atoxswap.com/docs/v2/core-concepts/pools/"
              >
                <ThemedText.White fontSize={14}>
            ...
            <AutoColumn gap="md" style={{ width: '100%' }}>
              <Layer2Prompt>
                <ThemedText.Body color={theme.text3} textAlign="center">
                  <Trans>V2 is not available on yet. Switch to v1 Ethereum.</Trans>
                </ThemedText.Body>
              </Layer2Prompt>
            </AutoColumn>
          </AutoColumn>
              ...
              {!account ? (
                ...
                <>
                  <ButtonSecondary>
                    <RowBetween>
                      <Trans>
                        <ExternalLink href={'https://info.atoxswap.com/account/' + account}>
                  ...
                  <RowFixed justify="center" style={{ width: '100%' }}>
                    ...
                    >
                      ...
                      <Trans>Be Ready To Migrate Liquidity to v2</Trans>
                    </ButtonOutlined>
                  </RowFixed>
                </>
              ) : (
