    ...
    <>
      <PageWrapper gap="lg" justify="center">
              ...
              <AutoColumn gap="md">
                <RowBetween>
                  <ThemedText.White fontWeight={600}>
                    <Trans>atoxSwap Governance</Trans>
                  </ThemedText.White>
                </RowBetween>
                <RowBetween>
                  <ThemedText.White fontSize={14}>
                    <Trans>
                      ATOX tokens represent voting shares in atoxSwap governance. You can vote on each proposal yourself
                ...
                <ExternalLink
                  ...
                  href="https://atoxswap.com/blog/atox"
                  target="_blank"
                >
                  <ThemedText.White fontSize={14}>
                    <Trans>Read more about atoxSwap governance</Trans>
                  </ThemedText.White>
                </ExternalLink>
              </AutoColumn>
            </CardSection>
        ...
        <ThemedText.SubHeader color="text3">
          <Trans>A minimum threshold of 0.25% of the total ATOX supply is required to submit proposals</Trans>
